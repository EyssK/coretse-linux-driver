 ...
 *
 * Register bit offsets and masks definitions for CoreTSE.
 *
 * SVN $Revision: 9728 $
 ...
 * These constants correspond to the Misc Control register(0x1D4) of CoreTSE.
   ...
   in-turn be used to generate the appropriate TX-RX clocks in the Lebro Design
...
#define CFG1_TX_RST_OFFSET                      0x00u
#define CFG1_TX_RST_MASK                        0x00010000UL
#define CFG1_TX_RST_SHIFT                       16u

#define CFG1_RX_RST_OFFSET                      0x00u
#define CFG1_RX_RST_MASK                        0x00020000UL
#define CFG1_RX_RST_SHIFT                       17u

#define CFG1_TXCTL_RST_OFFSET                   0x00u
#define CFG1_TXCTL_RST_MASK                     0x00040000UL
#define CFG1_TXCTL_RST_SHIFT                    18u

#define CFG1_RXCTL_RST_OFFSET                   0x00u
#define CFG1_RXCTL_RST_MASK                     0x00080000UL
#define CFG1_RXCTL_RST_SHIFT                    19u

#define CFG1_SOFT_RST_OFFSET                    0x00u
#define CFG1_SOFT_RST_MASK                      0x80000000UL
#define CFG1_SOFT_RST_SHIFT                     31u
...
#define CFPT_REG_OFFSET                         0x18u

#define CFPT_CFEP_OFFSET                        0x18u
#define CFPT_CFEP_MASK                          0x0000FFFFUL
#define CFPT_CFEP_SHIFT                         0u
...
#define MIIMGMT_RESET_MII_MGMT_MASK             0x10000000UL
...
#define IFC_RGMII_LHD_OFFSET                    0x38u
#define IFC_RGMII_LHD_MASK                      0x02000000UL
#define IFC_RGMII_LHD_SHIFT                     25u

#define IFC_RGMII_GHD_OFFSET                    0x38u
#define IFC_RGMII_GHD_MASK                      0x04000000UL
#define IFC_RGMII_GHD_SHIFT                     26u

#define IFC_RGMII_TBI_OFFSET                    0x38u
#define IFC_RGMII_TBI_MASK                      0x08000000UL
#define IFC_RGMII_TBI_SHIFT                     27u

#define IFC_RESET_OFFSET                        0x38u
#define IFC_RESET_MASK                          0x80000000UL
#define IFC_RESET_SHIFT                         31u
...
#define MISCSTATUS_REG_OFFSET                   0x1D8u
